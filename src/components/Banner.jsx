    ...
    <Grid container sx={{ background: 'linear-gradient(to bottom, #00B4AA 6.67%, #A4D96C 84.1%)', minHeight: '643px' }}>
      <Grid item xs={12} sm={6} md={6} order={{ xs: 2, sm: 1 }} sx={{ display: 'flex', alignItems: 'center', padding: '2rem' }}>
        <Box sx={{ color: 'white' }}>
          ...
          <Button variant="contained" sx={{ background: 'rgba(255, 255, 255, 1)', color: 'rgba(35, 187, 134, 1)', padding: '1rem 3rem', transition: '0.3s', '&:hover': { backgroundColor: 'rgba(35, 187, 134, 1)', color: 'white', boxShadow: '0px 4px 8px rgba(35, 187, 134, 0.5)' } }}>
            Get Started
          </Button>
        </Box>
      </Grid>
