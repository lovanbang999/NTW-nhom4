    ...
    <Grid
      ...
      <Grid
        ...
        <Box sx={{ color: 'white' }}>
          ...
          <Button component="a"
            href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley" variant="contained" target="_blank" sx={{ background: 'rgba(255, 255, 255, 1)', color: 'rgba(35, 187, 134, 1)', padding: '1rem 3rem', transition: '0.3s', '&:hover': { backgroundColor: 'rgba(35, 187, 134, 1)', color: 'white', boxShadow: '0px 4px 8px rgba(35, 187, 134, 0.5)' } }}>
            Get Started
          </Button>
        </Box>
      </Grid>
